...
import kotlinx.android.synthetic.main.activity_brainwave_spectrum_line_chart.*

class BrainwaveSpectrumLineChartActivity : AppCompatActivity() {

    @SuppressLint("SourceLockedOrientationActivity")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_brainwave_spectrum_line_chart)
