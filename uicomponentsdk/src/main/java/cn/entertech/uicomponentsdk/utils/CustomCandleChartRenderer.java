...
class CustomCandleChartRenderer extends LineScatterCandleRadarRenderer {
...
//         mHighlightLinePath.moveTo(x, mViewPortHandler.contentTop()-Utils.convertDpToPixel(20));
