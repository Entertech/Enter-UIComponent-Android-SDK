...
class RealtimeChartLegendView @JvmOverloads constructor(
    context: Context,
    ...
    private var mTextColor: Int = Color.parseColor("#5167f8")
    private var mOnCheckListener: ((Boolean) -> Unit)? = null
    var mIsChecked = true
    var mColor = Color.parseColor("#5167f8")
    var mLegend:String? = ""
    var self: View =
        LayoutInflater.from(context).inflate(R.layout.layout_realtime_chart_legend, null)
